class Python33 < Formula
  ...
  bottle do
    ...
    sha256 "57f046efd0f6575e646bd1fee7db44b0ce2266f05bfb5d775053c7c5a4d88611" => :sierra
  end
  ...
  def install
    ...
    # Any .app get a " 33" attached, so it does not conflict with python 2.x or any other
    # python 3.x version
    Dir.glob("#{prefix}/*.app") { |app| mv app, app.sub(".app", " 33.app") }
