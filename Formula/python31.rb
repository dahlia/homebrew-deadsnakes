class Python31 < Formula
  ...
  bottle do
    ...
    sha256 "2002a00a417caff2548afe014463ed33c7f4b3e4e76eaf71c6ff1d5b758dda99" => :sierra
  end
  ...
  def install
    ...
    # Any .app get a " 32" attached, so it does not conflict with python 2.x or any other
    # python 3.x version
    Dir.glob("#{prefix}/*.app") { |app| mv app, app.sub(".app", " 32.app") }
